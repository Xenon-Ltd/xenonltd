...
export default function BaasHero() {
  return (
    <div className="relative min-h-[70vh] flex flex-col bg-[#F9F4F1] overflow-hidden">
      ...
      {/* Hero Banner Card — px matches Container so card aligns with navbar */}
      <div className="flex-1 flex items-center py-12 px-6 sm:px-8 lg:px-12">
        <Container className="relative rounded-[2rem] overflow-hidden min-h-[500px] flex items-center w-full shadow-md">
          {/* Background Image & Overlay */}
          <div className="absolute inset-0 z-0">
            <Image
              src="/images/baas-hero-bg.png"
              alt="Xenon Banking as a Service"
              fill
              priority
          ...
          {/* Texts */}
          <div className="relative z-10 w-full px-6 sm:px-10 py-12 flex flex-col items-start gap-4">
            {/* Tag */}
